...
const ChatBox = () => {
    ...
    //             // Check if the received message is from the currently selected chat
    //             if (!selectedChat || selectedChat._id !== newMessageReceived.chat._id) {
    //                 // Add the message to the notification array if it's not being viewed
    //                 if (!notification.some((msg) => msg._id === newMessageReceived._id)) {
    //                     dispatch(setNotification([newMessageReceived, ...notification]));
    //                     dispatch(fetchChat());
    //                 }
    //             } else {
    //                 // If the chat is selected, update the message list
    ...
    //         };
    //     }
    // }, [socket, selectedChat, notification, dispatch]);
